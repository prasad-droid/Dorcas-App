    ...
    >
      ...
      <div className="flex-1 px-5 pt-2 pb-20 space-y-3">
        <div className="flex items-center justify-between px-1 mb-4">
           <h3 className="text-[11px] font-bold text-brand/30 uppercase tracking-[2px]">Partner Dashboard</h3>
           <span className="text-[9px] font-black bg-brand/5 text-brand px-2 py-1 rounded-md uppercase tracking-wider">Expert Level</span>
        </div>
